...
<div class="printable-area-box"
    ...
    <div class="edit-box marching-ants marching draggable" v-show="message">
        ...
        {{--Resize elements (uncomment and work on them)--}}

        {{--<div class="handle handle-noimage" style="width: 12px; height: 12px; left: 262px; top: 247.981px;"></div>--}}
        {{--<div class="handle handle-noimage" style="width: 12px; height: 12px; left: 281.344px; top: 261.241px;"></div>--}}
        {{--<div class="handle handle-noimage" style="width: 12px; height: 12px; left: 262px; top: 274.5px;"></div>--}}
        {{--<div class="handle handle-noimage" style="width: 12px; height: 12px; left: 242.656px; top: 261.241px;"></div>--}}
    ...
    <div class="printable-area-toolbar" data-element="toolbarEl"
